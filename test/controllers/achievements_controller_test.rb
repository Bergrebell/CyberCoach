...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { category_id: @achievement.category_id, points: @achievement.points, title: @achievement.title }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { category_id: @achievement.category_id, points: @achievement.points, title: @achievement.title }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
